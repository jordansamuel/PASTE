...
// Get username and check if it's exists in database. If invalid, redirect to main site.
if ( isset( $_GET['user'] ) ) {
...
$p_title = $user_username . "'s " . $lang['user_public_pastes']; // "Username's Pastes"
...
require_once('theme/' . $default_theme . '/user_public_pastes.php');
