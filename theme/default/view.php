            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn-group" role="group" aria-label="Paste actions">
                        ...
                        <a href="<?php echo htmlspecialchars($p_raw ?? ($protocol . $baseurl . '/raw.php?id=' . ($paste_id ?? ''))); ?>" class="btn btn-outline-secondary" title="Raw Paste">
                            <i class="bi bi-file-text"></i>
                        </a>
                        <a href="<?php echo htmlspecialchars($p_download ?? ($protocol . $baseurl . '/download.php?id=' . ($paste_id ?? ''))); ?>" class="btn btn-outline-secondary" title="Download">
